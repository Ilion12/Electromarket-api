...
import com.electromarket.rest.TelevisorConAlmacenController;
import com.fasterxml.jackson.databind.ObjectMapper;



	@Configuration
	@ComponentScan("com.electromarket")
	public class ConfiguracionPorJava {
	  ...
	  RepresentationModelProcessor<RepositorySearchesResource> addSearchLinks(
	    ...
	    controllersRegistrados.put(TelevisorConAlmacen.class,TelevisorConAlmacenController.class);
